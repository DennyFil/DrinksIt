...
public class OrderTable {
		...
		throws IOException
	{
		...
		cell = barRow.createCell((100 / 6f), new Integer(bar.getBar_id()).toString());
		cell.setFont(PDType1Font.HELVETICA);
		cell.setFillColor(Color.CYAN);
		cell.setTextColor(Color.BLACK);
		...
		while (it.hasNext()) {
			...
			cell = row.createCell((100 / 6f), new Integer(order.getOrder_id()).toString());
			cell.setFont(PDType1Font.HELVETICA);
			cell.setFontSize(6);

			cell = row.createCell((100 / 6f), order.getCreationTS());
			cell.setFont(PDType1Font.HELVETICA);
			cell.setFontSize(6);
			...
			cell = row.createCell((100 / 6f), new Integer(order.getDrink().getDrink_id()).toString());
			cell.setFont(PDType1Font.HELVETICA);
			cell.setFontSize(6);
